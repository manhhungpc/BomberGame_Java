...
//        window.getContentPane().setBackground(Color.black);
        window.setContentPane(new JLabel(new ImageIcon("F:\\CodeUET\\Java\\OOP\\BomberGame_Java\\src\\resource\\image\\background.png")));
...
//        choice1.addActionListener(lvHandler);
...
//        choice2.addActionListener(lvHandler);
